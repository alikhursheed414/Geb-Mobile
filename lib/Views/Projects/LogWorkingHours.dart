...
class LogWorkingHours extends StatefulWidget {
  const LogWorkingHours({Key? key}) : super(key: key);

  @override
  State<LogWorkingHours> createState() => _ProjectsState();
}

class _ProjectsState extends State<LogWorkingHours> {
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  SvgPicture.asset("assets/icons/profile.svg", height: 23.h,width: 23.w,),
                  Image.asset("assets/images/logo.png",height: 60.h,width: 75.65.w,),
                  Image.asset("assets/images/many.png",height: 15.h,width: 23.w,),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        margin: EdgeInsets.only(top: 20.h),
                        child: Text("Choose Project to Log Work: ", style: GoogleFonts.poppins(
                          //fontFamily: 'Alice-Regular',
                            fontSize: 15.sp,
